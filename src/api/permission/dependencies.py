...
RequireAttachmentManagement = require_permission("attachment", "*")
RequireAttachmentRead       = require_permission("attachment", "read")
RequireAttachmentCreate     = require_permission("attachment", "create")
RequireAttachmentUpdate     = require_permission("attachment", "update")
RequireAttachmentDelete     = require_permission("attachment", "delete")
