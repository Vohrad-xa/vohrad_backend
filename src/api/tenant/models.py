...
class Tenant(Base):
    ...
    license_id          = sa.Column(sa.UUID, sa.ForeignKey("shared.licenses.id", ondelete="SET NULL"), nullable=True)
    stripe_id           = sa.Column(sa.String, nullable=True, comment="Stripe customer ID")
