...
from typing import Any, Generic, NoReturn, Optional, Protocol, Type, TypeVar
...
class BaseService(Generic[ModelType, CreateSchemaType, UpdateSchemaType], ABC):
    ...
    async def _count_with_filters(
        ...
        search_conditions: Optional[list] = None,
        filters = None,
    ) -> int:
    ...
    async def _handle_integrity_error(
        ...
        """Handle IntegrityError with constraint-specific exceptions."""
